                  ...
                  ($(document)
                    ...
                    $(t.elem).bind("keyup", function (t) {
                      ...
                      ((8 === t.keyCode ||
                        ...
                        (a &&
                          (86 == t.keyCode || $.inArray(t.keyCode, s) > 0))) &&
                        (r = !0),
                        r &&
                          (clearTimeout(i),
                  ...
                  var e = this,
                    t = function t(i) {
                      $(i.target).is(e.elem) ||
                        ...
                        0 !=
                          $(i.target).closest(
                            "#" + e.model.view.$container.attr("id"),
                          ).length ||
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    if (
                      "persian" === this.model.options.initialValueType &&
                      i
                    ) {
                      var o = new s(),
                    ...
                    this.initialUnix =
                      e && "undefined" != e ? e : new Date().valueOf();
                  }
            ...
            a(e, [
              {
                ...
                value: function () {
                  if (this.model.options.navigator.scroll.enabled) {
                    var e = this,
                      t = $(
                        "#" + e.model.view.id + " .datepicker-grid-view",
                      )[0];
                    (o(t).wheel(function (t, i) {
                      ...
                      this.model.options.timePicker.enabled &&
                        $("#" + e.model.view.id + " .time-segment").each(
                          function () {
                      ...
                      $(document).on(
                        ...
                        function () {
                          ...
                          (e.model.state.setSelectedDateTime("unix", t),
                            (i =
                              e.model.state.selected.month !==
                              e.model.state.view.month),
        ...
        c = (function () {
          function e(t) {
            (a(this, e),
              ...
              (this.$container = null),
              (this.id =
                "persianDateInstance-" + parseInt(1e3 * Math.random(100))));
            var i = this;
            return (
                ...
                value: function (e) {
                  ...
                  var a = []
                      ...
                      .map(function (i) {
                        return (
                          i +
                          parseInt(e.year / t.yearsViewCount) * t.yearsViewCount
                        );
                      }),
                    o = [],
                  ...
                  try {
                    for (
                      ...
                      t.push({
                        ...
                        dataMonth: c + 1,
                        selected:
                          this.model.state.selected.year ==
              ...
              },
              {
                ...
                value: function (e) {
                  ...
                  return {
                    ...
                    altCalendarShowHint:
                      this.model.options.calendar[t[0]].showHint,
                ...
                value: function () {
                  ...
                  return (
                    "persian" == e.model.options.calendar_
                      ...
                      : ((t = "persian"),
                        (i = e.model.options.calendar.persian.locale)),
                    [t, i]
                  );
                },
              },
        ...
        ((n.SUPPORT = "wheel"),
          ...
          (n.event = {
            ...
            remove: function (e, t, i, a) {
              for (
                var o, s = i, r = {}, l = 0, d = e.handlers.length;
                l < d;
                ++l
              )
              ...
              for (var s, r, l, d = this, c = !1; d; ) {
                if (e.indexOf(".") > 0)
                  for (
                    ...
                    (l === r.length - 1 && (c = a(s, r[l]) || o(s, r[l])),
                      (s = s[r[l++]]));
